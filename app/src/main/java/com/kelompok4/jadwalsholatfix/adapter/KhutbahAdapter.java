package com.kelompok4.jadwalsholatfix.adapter;
...
import com.kelompok4.jadwalsholatfix.view.activity.EditKhutbahActivity;
...
public class KhutbahAdapter extends RecyclerView.Adapter<KhutbahAdapter.ViewHolder> {
    ...
    public KhutbahAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_khutbah,parent,false);
